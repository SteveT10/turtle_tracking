...
/**
 * Set SPI rate to less than 3Mhz to perform DW1000 initialization properly
 */
void setSpiRateLow(void);

/**
 * Set SPI rate to less than 20 Mhz for optimal 100 points.
 */
