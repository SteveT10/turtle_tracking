...
void main(void)
{
    ...
    initDWMinterrupt(GPIO_PORT_P5, GPIO_PIN4);
 ...
 *    For development purposes it is possible to generate a DW1000 unique ID by combining the Lot ID & Part Number values programmed into the-k
