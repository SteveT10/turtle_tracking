...
The DW1000 API package is composed of the following folders:
    ...
    - tests:
      ...
      Some user application code for testing platform implementaton of low-level features
      in CCS on MSP430fr2764.
      Additional User App Code can go here.
      
    - driverlib:
      "MSPware" Peripheral drivers for MSP430 processors. Provided by TI.
      
    - platform:

      Platform dependant implementation of low-level features (SPI management,
      mutex, sleep).
